...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "rumbleBox.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = std::tan((628.318542f / fConst0));
		fConst2 = (1.0f / fConst1);
		fConst3 = (1.0f / (fConst2 + 0.822445929f));
		fConst4 = (0.822445929f - fConst2);
		fConst5 = (1.0f / (((fConst2 + 0.802636743f) / fConst1) + 1.4122709f));
		fConst6 = mydsp_faustpower2_f(fConst1);
		fConst7 = (0.0198091455f / fConst6);
		fConst8 = (fConst7 + 1.16151643f);
		fConst9 = (1.0f / fConst0);
		fConst10 = (2.06999993f / fConst0);
		fConst11 = (3.31999993f / fConst0);
		fConst12 = (5.0f / fConst0);
		fConst13 = (((fConst2 + -0.802636743f) / fConst1) + 1.4122709f);
		fConst14 = (2.0f * (1.4122709f - (1.0f / fConst6)));
		fConst15 = (2.0f * (1.16151643f - fConst7));
		fConst16 = std::exp((0.0f - (200.0f / fConst0)));
		fConst17 = (1.0f - fConst16);
		fConst18 = std::exp((0.0f - (100.0f / fConst0)));
		fConst19 = std::exp((0.0f - (20.0f / fConst0)));
		fConst20 = std::tan((1570.79639f / fConst0));
		fConst21 = (1.0f / fConst20);
		fConst22 = (1.0f / (fConst21 + 0.822445929f));
		fConst23 = (0.822445929f - fConst21);
		fConst24 = (1.0f / (((fConst21 + 0.802636743f) / fConst20) + 1.4122709f));
		fConst25 = mydsp_faustpower2_f(fConst20);
		fConst26 = (0.0198091455f / fConst25);
		fConst27 = (fConst26 + 1.16151643f);
		fConst28 = std::exp((0.0f - (50.0f / fConst0)));
		fConst29 = std::max<float>(1.0f, (0.0250000004f * fConst0));
		fConst30 = (1.0f / fConst29);
		fConst31 = (0.899999976f * fConst0);
		fConst32 = std::exp((0.0f - (400.0f / fConst0)));
		fConst33 = (1.0f - fConst32);
		fConst34 = (((fConst21 + -0.802636743f) / fConst20) + 1.4122709f);
		fConst35 = (2.0f * (1.4122709f - (1.0f / fConst25)));
		fConst36 = (2.0f * (1.16151643f - fConst26));
		fConst37 = (3.14159274f / fConst0);
		fConst38 = (1382.30078f / fConst0);
		fConst39 = (0.165289253f * fConst0);
		fConst40 = (110.0f / fConst0);
		fConst41 = (1269.20349f / fConst0);
		fConst42 = (0.196059212f * fConst0);
		fConst43 = (130.809998f / fConst0);
		fConst44 = (1281.76978f / fConst0);
		fConst45 = (0.192233756f * fConst0);
		fConst46 = (164.809998f / fConst0);
		fConst47 = (1520.53088f / fConst0);
		fConst48 = (0.136602685f * fConst0);
		fConst49 = (196.0f / fConst0);
		fConst50 = (1319.46887f / fConst0);
		fConst51 = (0.181405902f * fConst0);
		fConst52 = (293.660004f / fConst0);
		fConst53 = (440.0f / fConst0);
		fConst54 = (4.0f / fConst0);
		fConst55 = (0.00249999994f * fConst0);
		fConst56 = (0.247500002f * fConst0);
	}
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider6 = FAUSTFLOAT(250.0f);
		fHslider7 = FAUSTFLOAT(0.01f);
		fHslider8 = FAUSTFLOAT(0.0f);
		fHslider9 = FAUSTFLOAT(0.0f);
		fHslider10 = FAUSTFLOAT(-10.0f);
		fHslider11 = FAUSTFLOAT(100.0f);
		fHslider12 = FAUSTFLOAT(0.20000000000000001f);
		fHslider13 = FAUSTFLOAT(0.029999999999999999f);
		fHslider14 = FAUSTFLOAT(800.0f);
		fHslider15 = FAUSTFLOAT(0.01f);
		fHslider16 = FAUSTFLOAT(81.0f);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("rumbleBox");
		ui_interface->addHorizontalSlider("aMinDist", &fHslider7, 0.00999999978f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->addHorizontalSlider("aMinEno", &fHslider8, 0.0f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("aMinLPF", &fHslider6, 250.0f, 5.0f, 800.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("aMinVol", &fHslider9, 0.0f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("kickVol", &fHslider4, 1.20000005f, 0.0f, 10.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("kikSpd", &fHslider5, 0.100000001f, 0.100000001f, 2.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("mcomp", &fHslider10, -10.0f, -50.0f, 0.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("mcompra", &fHslider11, 100.0f, 1.0f, 100.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("mvol", &fHslider0, 0.0f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("pipDist", &fHslider15, 0.00999999978f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->addHorizontalSlider("pipLP", &fHslider14, 800.0f, 5.0f, 800.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("pipVol", &fHslider13, 0.0299999993f, 0.0f, 10.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("rscal", &fHslider12, 0.200000003f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("setPip", &fHslider16, 81.0f, 80.0f, 110.0f, 1.0f);
		ui_interface->addHorizontalSlider("techno", &fHslider3, 0.0f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("wobFreq", &fHslider2, 1.0f, 0.5f, 10.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("wobWob", &fHslider1, 0.0f, 0.0f, 10.0f, 0.00999999978f);
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow9 = std::tan((fConst37 * float(fHslider6)));
		float fSlow10 = (1.0f / fSlow9);
		float fSlow11 = (1.0f / (fSlow10 + 0.822445929f));
		float fSlow12 = (0.822445929f - fSlow10);
		float fSlow13 = (1.0f / (((fSlow10 + 0.802636743f) / fSlow9) + 1.4122709f));
		float fSlow14 = mydsp_faustpower2_f(fSlow9);
		float fSlow15 = (0.0198091455f / fSlow14);
		float fSlow16 = (fSlow15 + 1.16151643f);
		float fSlow17 = std::pow(10.0f, (2.0f * float(fHslider7)));
		float fSlow18 = (0.00100000005f * float(fHslider8));
		float fSlow19 = (((fSlow10 + -0.802636743f) / fSlow9) + 1.4122709f);
		float fSlow20 = (2.0f * (1.4122709f - (1.0f / fSlow14)));
		float fSlow21 = (2.0f * (1.16151643f - fSlow15));
		float fSlow22 = (0.00100000005f * float(fHslider9));
		float fSlow23 = (0.00100000005f * float(fHslider10));
		float fSlow24 = (0.00100000005f * float(fHslider11));
		float fSlow25 = (0.00100000005f * float(fHslider12));
		float fSlow26 = float(fHslider13);
		float fSlow27 = std::tan((fConst37 * float(fHslider14)));
		float fSlow28 = (1.0f / fSlow27);
		float fSlow29 = (1.0f / (fSlow28 + 0.822445929f));
		float fSlow30 = (0.822445929f - fSlow28);
		float fSlow31 = (1.0f / (((fSlow28 + 0.802636743f) / fSlow27) + 1.4122709f));
		float fSlow32 = mydsp_faustpower2_f(fSlow27);
		float fSlow33 = (0.0198091455f / fSlow32);
		float fSlow34 = (fSlow33 + 1.16151643f);
		float fSlow35 = std::pow(10.0f, (2.0f * float(fHslider15)));
		float fSlow36 = float(fHslider16);
		float fSlow37 = (((fSlow28 + -0.802636743f) / fSlow27) + 1.4122709f);
		float fSlow38 = (2.0f * (1.4122709f - (1.0f / fSlow32)));
		float fSlow39 = (2.0f * (1.16151643f - fSlow33));
		for (int i = 0; (i < count); i = (i + 1)) {
			iVec0[0] = 1;
			fRec0[0] = (fSlow0 + (0.999000013f * fRec0[1]));
			fRec3[0] = (fSlow1 + (0.999000013f * fRec3[1]));
			fRec6[0] = (fSlow3 + (fRec6[1] - std::floor((fSlow3 + fRec6[1]))));
			float fTemp0 = (fRec5[1] + (fConst9 * ((fSlow2 * (ftbl0mydspSIG0[int((65536.0f * fRec6[0]))] + 20.0f)) + 35.0f)));
			fRec5[0] = (fTemp0 - std::floor(fTemp0));
			fRec8[0] = (fSlow4 + (fRec8[1] - std::floor((fSlow4 + fRec8[1]))));
			float fTemp1 = (fRec7[1] + (fConst9 * ((fSlow2 * (ftbl0mydspSIG0[int((65536.0f * fRec8[0]))] + 21.0f)) + 35.0f)));
			fRec7[0] = (fTemp1 - std::floor(fTemp1));
			fRec10[0] = (fSlow5 + (fRec10[1] - std::floor((fSlow5 + fRec10[1]))));
			float fTemp2 = (fRec9[1] + (fConst9 * ((fSlow2 * (ftbl0mydspSIG0[int((65536.0f * fRec10[0]))] + 10.0f)) + 25.0f)));
			fRec9[0] = (fTemp2 - std::floor(fTemp2));
			float fTemp3 = std::max<float>(-1.0f, std::min<float>(1.0f, (0.523564279f * (fRec3[0] * ((ftbl0mydspSIG0[int((65536.0f * fRec5[0]))] + ftbl0mydspSIG0[int((65536.0f * fRec7[0]))]) + ftbl0mydspSIG0[int((65536.0f * fRec9[0]))])))));
			fRec2[0] = ((fTemp3 * (1.0f - (0.333333343f * mydsp_faustpower2_f(fTemp3)))) - (fConst5 * ((fConst13 * fRec2[2]) + (fConst14 * fRec2[1]))));
			float fTemp4 = (((fConst8 * fRec2[0]) + (fConst15 * fRec2[1])) + (fConst8 * fRec2[2]));
			fVec1[0] = fTemp4;
			fRec1[0] = (0.0f - (fConst3 * ((fConst4 * fRec1[1]) - (fConst5 * (fTemp4 + fVec1[1])))));
			float fTemp5 = std::fabs(fRec1[0]);
			float fTemp6 = ((fRec12[1] > fTemp5) ? fConst19 : fConst18);
			fRec13[0] = ((fRec13[1] * fTemp6) + (fTemp5 * (1.0f - fTemp6)));
			fRec12[0] = fRec13[0];
			fRec11[0] = ((fConst16 * fRec11[1]) + (fConst17 * (0.0f - (0.99000001f * std::max<float>(((20.0f * std::log10(fRec12[0])) + 2.0f), 0.0f)))));
			float fTemp7 = (fRec1[0] * std::pow(10.0f, (0.0500000007f * fRec11[0])));
			fRec16[0] = (fSlow6 + (0.999000013f * fRec16[1]));
			fRec17[0] = (fSlow7 + (0.999000013f * fRec17[1]));
			float fTemp8 = ((fSlow8 * fRec16[0]) + 0.699999988f);
			float fTemp9 = (fRec21[1] + (fConst9 * fTemp8));
			fRec21[0] = (fTemp9 - std::floor(fTemp9));
			int iTemp10 = ((fRec21[0] - fRec21[1]) < 0.0f);
			iVec2[0] = iTemp10;
			float fTemp11 = float(iTemp10);
			float fTemp12 = ((fRec19[1] > fTemp11) ? fConst28 : 0.0f);
			fRec20[0] = ((fRec20[1] * fTemp12) + (fTemp11 * (1.0f - fTemp12)));
			fRec19[0] = fRec20[0];
			float fTemp13 = (400.0f * fRec19[0]);
			float fTemp14 = (fRec18[1] + (fConst9 * (fTemp13 + 27.5f)));
			fRec18[0] = (fTemp14 - std::floor(fTemp14));
			float fTemp15 = (fRec22[1] + (fConst9 * (fTemp13 + 55.0f)));
			fRec22[0] = (fTemp15 - std::floor(fTemp15));
			float fTemp16 = (ftbl0mydspSIG0[int((65536.0f * fRec18[0]))] + ftbl0mydspSIG0[int((65536.0f * fRec22[0]))]);
			iRec23[0] = (((iRec23[1] + (iRec23[1] > 0)) * (iTemp10 <= iVec2[1])) + (iTemp10 > iVec2[1]));
			float fTemp17 = float(iRec23[0]);
			float fTemp18 = std::max<float>(0.0f, std::min<float>((fConst30 * fTemp17), (((fConst29 - fTemp17) / std::max<float>(1.0f, (fConst31 / fTemp8))) + 1.0f)));
			float fTemp19 = std::fabs((fTemp16 * fTemp18));
			float fTemp20 = ((fRec25[1] > fTemp19) ? fConst18 : fConst16);
			fRec26[0] = ((fRec26[1] * fTemp20) + (fTemp19 * (1.0f - fTemp20)));
			fRec25[0] = fRec26[0];
			fRec24[0] = ((fConst32 * fRec24[1]) + (fConst33 * (0.0f - (0.99000001f * std::max<float>(((20.0f * std::log10(fRec25[0])) + 10.0f), 0.0f)))));
			float fTemp21 = std::pow(10.0f, (0.0500000007f * fRec24[0]));
			float fTemp22 = std::fabs((((fRec17[0] * fTemp16) * fTemp18) * fTemp21));
			float fTemp23 = ((fRec28[1] > fTemp22) ? fConst18 : fConst16);
			fRec29[0] = ((fRec29[1] * fTemp23) + (fTemp22 * (1.0f - fTemp23)));
			fRec28[0] = fRec29[0];
			fRec27[0] = ((fConst32 * fRec27[1]) + (fConst33 * (0.0f - (0.99000001f * std::max<float>(((20.0f * std::log10(fRec28[0])) + 5.0f), 0.0f)))));
			fRec15[0] = ((((((fRec16[0] * fRec17[0]) * fTemp16) * fTemp18) * fTemp21) * std::pow(10.0f, (0.0500000007f * fRec27[0]))) - (fConst24 * ((fConst34 * fRec15[2]) + (fConst35 * fRec15[1]))));
			float fTemp24 = (((fConst27 * fRec15[0]) + (fConst36 * fRec15[1])) + (fConst27 * fRec15[2]));
			fVec3[0] = fTemp24;
			fRec14[0] = (0.0f - (fConst22 * ((fConst23 * fRec14[1]) - (fConst24 * (fTemp24 + fVec3[1])))));
			fRec37[0] = (fSlow18 + (0.999000013f * fRec37[1]));
			float fTemp25 = (fConst38 * fRec37[0]);
			float fTemp26 = std::sin(fTemp25);
			float fTemp27 = std::cos(fTemp25);
			fRec35[0] = ((fRec36[1] * fTemp26) + (fRec35[1] * fTemp27));
			float fTemp28 = float((1 - iVec0[1]));
			fRec36[0] = ((fTemp28 + (fRec36[1] * fTemp27)) - (fTemp26 * fRec35[1]));
			int iTemp29 = ((fRec35[1] <= 0.0f) & (fRec35[0] > 0.0f));
			iRec38[0] = ((1103515245 * iRec38[1]) + 12345);
			float fTemp30 = float(iRec38[0]);
			fRec34[0] = ((fRec34[1] * float((1 - iTemp29))) + (4.65661287e-10f * (fTemp30 * float(iTemp29))));
			int iTemp31 = (fRec34[0] > 0.99000001f);
			iVec4[0] = iTemp31;
			iRec33[0] = (((iRec33[1] + (iRec33[1] > 0)) * (iTemp31 <= iVec4[1])) + (iTemp31 > iVec4[1]));
			float fTemp32 = mydsp_faustpower2_f(fRec37[0]);
			float fTemp33 = (float(iRec33[0]) / std::max<float>(1.0f, (fConst39 / fTemp32)));
			fRec32[0] = ((0.999000013f * fRec32[1]) + (0.00100000005f * std::max<float>(0.0f, std::min<float>(fTemp33, (2.0f - fTemp33)))));
			fRec39[0] = (fConst40 + (fRec39[1] - std::floor((fConst40 + fRec39[1]))));
			float fTemp34 = (fConst41 * fRec37[0]);
			float fTemp35 = std::sin(fTemp34);
			float fTemp36 = std::cos(fTemp34);
			fRec43[0] = ((fRec44[1] * fTemp35) + (fRec43[1] * fTemp36));
			fRec44[0] = ((fTemp28 + (fRec44[1] * fTemp36)) - (fTemp35 * fRec43[1]));
			int iTemp37 = ((fRec43[1] <= 0.0f) & (fRec43[0] > 0.0f));
			fRec42[0] = ((fRec42[1] * float((1 - iTemp37))) + (4.65661287e-10f * (fTemp30 * float(iTemp37))));
			int iTemp38 = (fRec42[0] > 0.99000001f);
			iVec5[0] = iTemp38;
			iRec41[0] = (((iRec41[1] + (iRec41[1] > 0)) * (iTemp38 <= iVec5[1])) + (iTemp38 > iVec5[1]));
			float fTemp39 = (float(iRec41[0]) / std::max<float>(1.0f, (fConst42 / fTemp32)));
			fRec40[0] = ((0.999000013f * fRec40[1]) + (0.00100000005f * std::max<float>(0.0f, std::min<float>(fTemp39, (2.0f - fTemp39)))));
			fRec45[0] = (fConst43 + (fRec45[1] - std::floor((fConst43 + fRec45[1]))));
			float fTemp40 = (fConst44 * fRec37[0]);
			float fTemp41 = std::sin(fTemp40);
			float fTemp42 = std::cos(fTemp40);
			fRec49[0] = ((fRec50[1] * fTemp41) + (fRec49[1] * fTemp42));
			fRec50[0] = ((fTemp28 + (fRec50[1] * fTemp42)) - (fTemp41 * fRec49[1]));
			int iTemp43 = ((fRec49[1] <= 0.0f) & (fRec49[0] > 0.0f));
			fRec48[0] = ((fRec48[1] * float((1 - iTemp43))) + (4.65661287e-10f * (fTemp30 * float(iTemp43))));
			int iTemp44 = (fRec48[0] > 0.99000001f);
			iVec6[0] = iTemp44;
			iRec47[0] = (((iRec47[1] + (iRec47[1] > 0)) * (iTemp44 <= iVec6[1])) + (iTemp44 > iVec6[1]));
			float fTemp45 = (float(iRec47[0]) / std::max<float>(1.0f, (fConst45 / fTemp32)));
			fRec46[0] = ((0.999000013f * fRec46[1]) + (0.00100000005f * std::max<float>(0.0f, std::min<float>(fTemp45, (2.0f - fTemp45)))));
			fRec51[0] = (fConst46 + (fRec51[1] - std::floor((fConst46 + fRec51[1]))));
			float fTemp46 = (fConst47 * fRec37[0]);
			float fTemp47 = std::sin(fTemp46);
			float fTemp48 = std::cos(fTemp46);
			fRec55[0] = ((fRec56[1] * fTemp47) + (fRec55[1] * fTemp48));
			fRec56[0] = ((fTemp28 + (fRec56[1] * fTemp48)) - (fTemp47 * fRec55[1]));
			int iTemp49 = ((fRec55[1] <= 0.0f) & (fRec55[0] > 0.0f));
			fRec54[0] = ((fRec54[1] * float((1 - iTemp49))) + (4.65661287e-10f * (fTemp30 * float(iTemp49))));
			int iTemp50 = (fRec54[0] > 0.99000001f);
			iVec7[0] = iTemp50;
			iRec53[0] = (((iRec53[1] + (iRec53[1] > 0)) * (iTemp50 <= iVec7[1])) + (iTemp50 > iVec7[1]));
			float fTemp51 = (float(iRec53[0]) / std::max<float>(1.0f, (fConst48 / fTemp32)));
			fRec52[0] = ((0.999000013f * fRec52[1]) + (0.00100000005f * std::max<float>(0.0f, std::min<float>(fTemp51, (2.0f - fTemp51)))));
			fRec57[0] = (fConst49 + (fRec57[1] - std::floor((fConst49 + fRec57[1]))));
			float fTemp52 = (fConst50 * fRec37[0]);
			float fTemp53 = std::sin(fTemp52);
			float fTemp54 = std::cos(fTemp52);
			fRec61[0] = ((fRec62[1] * fTemp53) + (fRec61[1] * fTemp54));
			fRec62[0] = ((fTemp28 + (fRec62[1] * fTemp54)) - (fTemp53 * fRec61[1]));
			int iTemp55 = ((fRec61[1] <= 0.0f) & (fRec61[0] > 0.0f));
			fRec60[0] = ((fRec60[1] * float((1 - iTemp55))) + (4.65661287e-10f * (fTemp30 * float(iTemp55))));
			int iTemp56 = (fRec60[0] > 0.99000001f);
			iVec8[0] = iTemp56;
			iRec59[0] = (((iRec59[1] + (iRec59[1] > 0)) * (iTemp56 <= iVec8[1])) + (iTemp56 > iVec8[1]));
			float fTemp57 = (float(iRec59[0]) / std::max<float>(1.0f, (fConst51 / fTemp32)));
			fRec58[0] = ((0.999000013f * fRec58[1]) + (0.00100000005f * std::max<float>(0.0f, std::min<float>(fTemp57, (2.0f - fTemp57)))));
			fRec63[0] = (fConst52 + (fRec63[1] - std::floor((fConst52 + fRec63[1]))));
			float fTemp58 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow17 * (((((fRec32[0] * ftbl0mydspSIG0[int((65536.0f * fRec39[0]))]) + (fRec40[0] * ftbl0mydspSIG0[int((65536.0f * fRec45[0]))])) + (fRec46[0] * ftbl0mydspSIG0[int((65536.0f * fRec51[0]))])) + (fRec52[0] * ftbl0mydspSIG0[int((65536.0f * fRec57[0]))])) + (fRec58[0] * ftbl0mydspSIG0[int((65536.0f * fRec63[0]))])))));
			fRec31[0] = ((fTemp58 * (1.0f - (0.333333343f * mydsp_faustpower2_f(fTemp58)))) - (fSlow13 * ((fSlow19 * fRec31[2]) + (fSlow20 * fRec31[1]))));
			float fTemp59 = (fSlow13 * (((fSlow16 * fRec31[0]) + (fSlow21 * fRec31[1])) + (fSlow16 * fRec31[2])));
			fVec9[0] = fTemp59;
			fRec30[0] = (0.0f - (fSlow11 * ((fSlow12 * fRec30[1]) - (fTemp59 + fVec9[1]))));
			fRec64[0] = (fSlow22 + (0.999000013f * fRec64[1]));
			float fTemp60 = std::fabs(fRec30[0]);
			float fTemp61 = ((fRec66[1] > fTemp60) ? fConst19 : fConst18);
			fRec67[0] = ((fRec67[1] * fTemp61) + (fTemp60 * (1.0f - fTemp61)));
			fRec66[0] = fRec67[0];
			fRec65[0] = ((fConst16 * fRec65[1]) + (fConst17 * (0.0f - (0.99000001f * std::max<float>(((20.0f * std::log10(fRec66[0])) + 5.0f), 0.0f)))));
			float fTemp62 = ((fRec30[0] * fRec64[0]) * std::pow(10.0f, (0.0500000007f * fRec65[0])));
			float fTemp63 = (fTemp7 + (fRec14[0] + fTemp62));
			float fTemp64 = std::fabs(fTemp63);
			float fTemp65 = ((fRec69[1] > fTemp64) ? fConst28 : fConst18);
			fRec70[0] = ((fRec70[1] * fTemp65) + (fTemp64 * (1.0f - fTemp65)));
			fRec69[0] = fRec70[0];
			fRec71[0] = (fSlow23 + (0.999000013f * fRec71[1]));
			fRec72[0] = (fSlow24 + (0.999000013f * fRec72[1]));
			float fTemp66 = ((1.0f / std::max<float>(1.1920929e-07f, fRec72[0])) + -1.0f);
			fRec68[0] = ((fConst16 * fRec68[1]) + (fConst17 * (std::max<float>(((20.0f * std::log10(fRec69[0])) - fRec71[0]), 0.0f) * fTemp66)));
			output0[i] = FAUSTFLOAT(((fRec0[0] * fTemp63) * std::pow(10.0f, (0.0500000007f * fRec68[0]))));
			fRec73[0] = (fSlow25 + (0.999000013f * fRec73[1]));
			float fTemp67 = (fRec78[1] + (fConst54 * fTemp8));
			fRec78[0] = (fTemp67 - std::floor(fTemp67));
			int iTemp68 = ((fRec78[0] - fRec78[1]) < 0.0f);
			fRec77[0] = (iTemp68 ? fSlow36 : fRec77[1]);
			float fTemp69 = (fRec76[1] + (fConst53 * std::pow(2.0f, (0.0833333358f * (fRec77[0] + -69.0f)))));
			fRec76[0] = (fTemp69 - std::floor(fTemp69));
			fRec80[0] = (iTemp68 ? (((4.65661287e-10f * fTemp30) + 1.0f) * float(iTemp68)) : fRec80[1]);
			int iTemp70 = (fRec80[0] > 0.800000012f);
			iVec10[0] = iTemp70;
			iRec79[0] = (iTemp70 + (iRec79[1] * (iVec10[1] >= iTemp70)));
			iRec81[0] = ((iTemp70 == 0) * (iRec81[1] + 1));
			float fTemp71 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow35 * (ftbl0mydspSIG0[int((65536.0f * fRec76[0]))] * std::max<float>(0.0f, (std::min<float>((float(iRec79[0]) / std::max<float>(1.0f, (fConst55 / fTemp8))), 1.0f) - (float(iRec81[0]) / std::max<float>(1.0f, (fConst56 / fTemp8)))))))));
			fRec75[0] = ((fTemp71 * (1.0f - (0.333333343f * mydsp_faustpower2_f(fTemp71)))) - (fSlow31 * ((fSlow37 * fRec75[2]) + (fSlow38 * fRec75[1]))));
			float fTemp72 = (fSlow31 * (((fSlow34 * fRec75[0]) + (fSlow39 * fRec75[1])) + (fSlow34 * fRec75[2])));
			fVec11[0] = fTemp72;
			fRec74[0] = (0.0f - (fSlow29 * ((fSlow30 * fRec74[1]) - (fTemp72 + fVec11[1]))));
			float fTemp73 = (fRec14[0] + (fSlow26 * fRec74[0]));
			float fTemp74 = std::fabs(fTemp73);
			float fTemp75 = ((fRec83[1] > fTemp74) ? fConst18 : fConst16);
			fRec84[0] = ((fRec84[1] * fTemp75) + (fTemp74 * (1.0f - fTemp75)));
			fRec83[0] = fRec84[0];
			fRec82[0] = ((fConst32 * fRec82[1]) + (fConst33 * (0.0f - (0.99000001f * std::max<float>(((20.0f * std::log10(fRec83[0])) + 5.0f), 0.0f)))));
			float fTemp76 = (((fRec16[0] * fTemp73) * std::pow(10.0f, (0.0500000007f * fRec82[0]))) + (fTemp7 + (0.5f * fTemp62)));
			float fTemp77 = std::fabs((fRec73[0] * fTemp76));
			float fTemp78 = ((fRec86[1] > fTemp77) ? fConst28 : fConst18);
			fRec87[0] = ((fRec87[1] * fTemp78) + (fTemp77 * (1.0f - fTemp78)));
			fRec86[0] = fRec87[0];
			fRec85[0] = ((fConst16 * fRec85[1]) + (fConst17 * (std::max<float>(((20.0f * std::log10(fRec86[0])) - fRec71[0]), 0.0f) * fTemp66)));
			output1[i] = FAUSTFLOAT((((fRec0[0] * fRec73[0]) * fTemp76) * std::pow(10.0f, (0.0500000007f * fRec85[0]))));
			iVec0[1] = iVec0[0];
			fRec0[1] = fRec0[0];
			fRec3[1] = fRec3[0];
			fRec6[1] = fRec6[0];
	...
	#define FAUST_FILE_NAME "rumbleBox.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("aMinDist", fHslider7, 0.01f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("aMinEno", fHslider8, 0.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("aMinLPF", fHslider6, 250.0f, 5.0f, 800.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("aMinVol", fHslider9, 0.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("kickVol", fHslider4, 1.2f, 0.0f, 10.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("kikSpd", fHslider5, 0.10000000000000001f, 0.10000000000000001f, 2.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("mcomp", fHslider10, -10.0f, -50.0f, 0.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("mcompra", fHslider11, 100.0f, 1.0f, 100.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("mvol", fHslider0, 0.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("pipDist", fHslider15, 0.01f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("pipLP", fHslider14, 800.0f, 5.0f, 800.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("pipVol", fHslider13, 0.029999999999999999f, 0.0f, 10.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("rscal", fHslider12, 0.20000000000000001f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("setPip", fHslider16, 81.0f, 80.0f, 110.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("techno", fHslider3, 0.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("wobFreq", fHslider2, 1.0f, 0.5f, 10.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("wobWob", fHslider1, 0.0f, 0.0f, 10.0f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, aMinDist, "aMinDist", fHslider7, 0.01f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, aMinEno, "aMinEno", fHslider8, 0.0f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, aMinLPF, "aMinLPF", fHslider6, 250.0f, 5.0f, 800.0f, 0.01f) \
		p(HORIZONTALSLIDER, aMinVol, "aMinVol", fHslider9, 0.0f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, kickVol, "kickVol", fHslider4, 1.2f, 0.0f, 10.0f, 0.01f) \
		p(HORIZONTALSLIDER, kikSpd, "kikSpd", fHslider5, 0.10000000000000001f, 0.10000000000000001f, 2.0f, 0.01f) \
		p(HORIZONTALSLIDER, mcomp, "mcomp", fHslider10, -10.0f, -50.0f, 0.0f, 0.01f) \
		p(HORIZONTALSLIDER, mcompra, "mcompra", fHslider11, 100.0f, 1.0f, 100.0f, 0.01f) \
		p(HORIZONTALSLIDER, mvol, "mvol", fHslider0, 0.0f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, pipDist, "pipDist", fHslider15, 0.01f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, pipLP, "pipLP", fHslider14, 800.0f, 5.0f, 800.0f, 0.01f) \
		p(HORIZONTALSLIDER, pipVol, "pipVol", fHslider13, 0.029999999999999999f, 0.0f, 10.0f, 0.01f) \
		p(HORIZONTALSLIDER, rscal, "rscal", fHslider12, 0.20000000000000001f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, setPip, "setPip", fHslider16, 81.0f, 80.0f, 110.0f, 1.0f) \
		p(HORIZONTALSLIDER, techno, "techno", fHslider3, 0.0f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, wobFreq, "wobFreq", fHslider2, 1.0f, 0.5f, 10.0f, 0.01f) \
		p(HORIZONTALSLIDER, wobWob, "wobWob", fHslider1, 0.0f, 0.0f, 10.0f, 0.01f) \
...
rumbleBox::rumbleBox() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void rumbleBox::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void rumbleBox::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float rumbleBox::getParamValue(const std::string& path)
{
