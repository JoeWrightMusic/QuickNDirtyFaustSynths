...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("kickVol", &fHslider3, 1.20000005f, 0.0f, 10.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("kikSpd", &fHslider5, 0.100000001f, 0.100000001f, 2.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("mcomp", &fHslider11, -10.0f, -50.0f, 0.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("mcompra", &fHslider10, 100.0f, 1.0f, 100.0f, 0.00999999978f);
		...
		ui_interface->addHorizontalSlider("techno", &fHslider4, 0.0f, 0.0f, 1.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow23 = (fConst17 * ((1.0f / std::max<float>(1.1920929e-07f, float(fHslider10))) + -1.0f));
		float fSlow24 = float(fHslider11);
		float fSlow25 = float(fHslider12);
		float fSlow26 = (fSlow25 * fSlow0);
		float fSlow27 = float(fHslider13);
		float fSlow28 = std::tan((fConst37 * float(fHslider14)));
		float fSlow29 = (1.0f / fSlow28);
		float fSlow30 = (1.0f / (fSlow29 + 0.822445929f));
		float fSlow31 = (0.822445929f - fSlow29);
		float fSlow32 = (1.0f / (((fSlow29 + 0.802636743f) / fSlow28) + 1.4122709f));
		float fSlow33 = mydsp_faustpower2_f(fSlow28);
		float fSlow34 = (0.0198091455f / fSlow33);
		float fSlow35 = (fSlow34 + 1.16151643f);
		float fSlow36 = std::pow(10.0f, (2.0f * float(fHslider15)));
		float fSlow37 = float(fHslider16);
		float fSlow38 = (((fSlow29 + -0.802636743f) / fSlow28) + 1.4122709f);
		float fSlow39 = (2.0f * (1.4122709f - (1.0f / fSlow33)));
		float fSlow40 = (2.0f * (1.16151643f - fSlow34));
		for (int i = 0; (i < count); i = (i + 1)) {
			iVec0[0] = 1;
			fRec2[0] = (fSlow1 + (0.999000013f * fRec2[1]));
			fRec5[0] = (fSlow3 + (fRec5[1] - std::floor((fSlow3 + fRec5[1]))));
			float fTemp0 = (fRec4[1] + (fConst9 * ((fSlow2 * (ftbl0mydspSIG0[int((65536.0f * fRec5[0]))] + 20.0f)) + 35.0f)));
			fRec4[0] = (fTemp0 - std::floor(fTemp0));
			fRec7[0] = (fSlow4 + (fRec7[1] - std::floor((fSlow4 + fRec7[1]))));
			float fTemp1 = (fRec6[1] + (fConst9 * ((fSlow2 * (ftbl0mydspSIG0[int((65536.0f * fRec7[0]))] + 21.0f)) + 35.0f)));
			fRec6[0] = (fTemp1 - std::floor(fTemp1));
			fRec9[0] = (fSlow5 + (fRec9[1] - std::floor((fSlow5 + fRec9[1]))));
			float fTemp2 = (fRec8[1] + (fConst9 * ((fSlow2 * (ftbl0mydspSIG0[int((65536.0f * fRec9[0]))] + 10.0f)) + 25.0f)));
			fRec8[0] = (fTemp2 - std::floor(fTemp2));
			float fTemp3 = std::max<float>(-1.0f, std::min<float>(1.0f, (0.523564279f * (fRec2[0] * ((ftbl0mydspSIG0[int((65536.0f * fRec4[0]))] + ftbl0mydspSIG0[int((65536.0f * fRec6[0]))]) + ftbl0mydspSIG0[int((65536.0f * fRec8[0]))])))));
			fRec1[0] = ((fTemp3 * (1.0f - (0.333333343f * mydsp_faustpower2_f(fTemp3)))) - (fConst5 * ((fConst13 * fRec1[2]) + (fConst14 * fRec1[1]))));
			float fTemp4 = (((fConst8 * fRec1[0]) + (fConst15 * fRec1[1])) + (fConst8 * fRec1[2]));
			fVec1[0] = fTemp4;
			fRec0[0] = (0.0f - (fConst3 * ((fConst4 * fRec0[1]) - (fConst5 * (fTemp4 + fVec1[1])))));
			float fTemp5 = std::fabs(fRec0[0]);
			float fTemp6 = ((fRec11[1] > fTemp5) ? fConst19 : fConst18);
			fRec12[0] = ((fRec12[1] * fTemp6) + (fTemp5 * (1.0f - fTemp6)));
			fRec11[0] = fRec12[0];
			fRec10[0] = ((fConst16 * fRec10[1]) + (fConst17 * (0.0f - (0.99000001f * std::max<float>(((20.0f * std::log10(fRec11[0])) + 2.0f), 0.0f)))));
			float fTemp7 = (fRec0[0] * std::pow(10.0f, (0.0500000007f * fRec10[0])));
			fRec15[0] = (fSlow7 + (0.999000013f * fRec15[1]));
			float fTemp8 = ((fSlow8 * fRec15[0]) + 0.699999988f);
			float fTemp9 = (fRec19[1] + (fConst9 * fTemp8));
			fRec19[0] = (fTemp9 - std::floor(fTemp9));
			int iTemp10 = ((fRec19[0] - fRec19[1]) < 0.0f);
			iVec2[0] = iTemp10;
			float fTemp11 = float(iTemp10);
			float fTemp12 = ((fRec17[1] > fTemp11) ? fConst28 : 0.0f);
			fRec18[0] = ((fRec18[1] * fTemp12) + (fTemp11 * (1.0f - fTemp12)));
			fRec17[0] = fRec18[0];
			float fTemp13 = (400.0f * fRec17[0]);
			float fTemp14 = (fRec16[1] + (fConst9 * (fTemp13 + 27.5f)));
			fRec16[0] = (fTemp14 - std::floor(fTemp14));
			float fTemp15 = (fRec20[1] + (fConst9 * (fTemp13 + 55.0f)));
			fRec20[0] = (fTemp15 - std::floor(fTemp15));
			float fTemp16 = (ftbl0mydspSIG0[int((65536.0f * fRec16[0]))] + ftbl0mydspSIG0[int((65536.0f * fRec20[0]))]);
			iRec21[0] = (((iRec21[1] + (iRec21[1] > 0)) * (iTemp10 <= iVec2[1])) + (iTemp10 > iVec2[1]));
			float fTemp17 = float(iRec21[0]);
			float fTemp18 = std::max<float>(0.0f, std::min<float>((fConst30 * fTemp17), (((fConst29 - fTemp17) / std::max<float>(1.0f, (fConst31 / fTemp8))) + 1.0f)));
			float fTemp19 = (fTemp16 * fTemp18);
			float fTemp20 = std::fabs(fTemp19);
			float fTemp21 = ((fRec23[1] > fTemp20) ? fConst18 : fConst16);
			fRec24[0] = ((fRec24[1] * fTemp21) + (fTemp20 * (1.0f - fTemp21)));
			fRec23[0] = fRec24[0];
			fRec22[0] = ((fConst32 * fRec22[1]) + (fConst33 * (0.0f - (0.99000001f * std::max<float>(((20.0f * std::log10(fRec23[0])) + 10.0f), 0.0f)))));
			float fTemp22 = std::pow(10.0f, (0.0500000007f * fRec22[0]));
			float fTemp23 = std::fabs((fSlow6 * (fTemp19 * fTemp22)));
			float fTemp24 = ((fRec26[1] > fTemp23) ? fConst18 : fConst16);
			fRec27[0] = ((fRec27[1] * fTemp24) + (fTemp23 * (1.0f - fTemp24)));
			fRec26[0] = fRec27[0];
			fRec25[0] = ((fConst32 * fRec25[1]) + (fConst33 * (0.0f - (0.99000001f * std::max<float>(((20.0f * std::log10(fRec26[0])) + 5.0f), 0.0f)))));
			fRec14[0] = ((fSlow6 * ((((fRec15[0] * fTemp16) * fTemp18) * fTemp22) * std::pow(10.0f, (0.0500000007f * fRec25[0])))) - (fConst24 * ((fConst34 * fRec14[2]) + (fConst35 * fRec14[1]))));
			float fTemp25 = (((fConst27 * fRec14[0]) + (fConst36 * fRec14[1])) + (fConst27 * fRec14[2]));
			fVec3[0] = fTemp25;
			fRec13[0] = (0.0f - (fConst22 * ((fConst23 * fRec13[1]) - (fConst24 * (fTemp25 + fVec3[1])))));
			fRec35[0] = (fSlow18 + (0.999000013f * fRec35[1]));
			float fTemp26 = (fConst38 * fRec35[0]);
			float fTemp27 = std::sin(fTemp26);
			float fTemp28 = std::cos(fTemp26);
			fRec33[0] = ((fRec34[1] * fTemp27) + (fRec33[1] * fTemp28));
			float fTemp29 = float((1 - iVec0[1]));
			fRec34[0] = ((fTemp29 + (fRec34[1] * fTemp28)) - (fTemp27 * fRec33[1]));
			int iTemp30 = ((fRec33[1] <= 0.0f) & (fRec33[0] > 0.0f));
			iRec36[0] = ((1103515245 * iRec36[1]) + 12345);
			float fTemp31 = float(iRec36[0]);
			fRec32[0] = ((fRec32[1] * float((1 - iTemp30))) + (4.65661287e-10f * (fTemp31 * float(iTemp30))));
			int iTemp32 = (fRec32[0] > 0.99000001f);
			iVec4[0] = iTemp32;
			iRec31[0] = (((iRec31[1] + (iRec31[1] > 0)) * (iTemp32 <= iVec4[1])) + (iTemp32 > iVec4[1]));
			float fTemp33 = mydsp_faustpower2_f(fRec35[0]);
			float fTemp34 = (float(iRec31[0]) / std::max<float>(1.0f, (fConst39 / fTemp33)));
			fRec30[0] = ((0.999000013f * fRec30[1]) + (0.00100000005f * std::max<float>(0.0f, std::min<float>(fTemp34, (2.0f - fTemp34)))));
			fRec37[0] = (fConst40 + (fRec37[1] - std::floor((fConst40 + fRec37[1]))));
			float fTemp35 = (fConst41 * fRec35[0]);
			float fTemp36 = std::sin(fTemp35);
			float fTemp37 = std::cos(fTemp35);
			fRec41[0] = ((fRec42[1] * fTemp36) + (fRec41[1] * fTemp37));
			fRec42[0] = ((fTemp29 + (fRec42[1] * fTemp37)) - (fTemp36 * fRec41[1]));
			int iTemp38 = ((fRec41[1] <= 0.0f) & (fRec41[0] > 0.0f));
			fRec40[0] = ((fRec40[1] * float((1 - iTemp38))) + (4.65661287e-10f * (fTemp31 * float(iTemp38))));
			int iTemp39 = (fRec40[0] > 0.99000001f);
			iVec5[0] = iTemp39;
			iRec39[0] = (((iRec39[1] + (iRec39[1] > 0)) * (iTemp39 <= iVec5[1])) + (iTemp39 > iVec5[1]));
			float fTemp40 = (float(iRec39[0]) / std::max<float>(1.0f, (fConst42 / fTemp33)));
			fRec38[0] = ((0.999000013f * fRec38[1]) + (0.00100000005f * std::max<float>(0.0f, std::min<float>(fTemp40, (2.0f - fTemp40)))));
			fRec43[0] = (fConst43 + (fRec43[1] - std::floor((fConst43 + fRec43[1]))));
			float fTemp41 = (fConst44 * fRec35[0]);
			float fTemp42 = std::sin(fTemp41);
			float fTemp43 = std::cos(fTemp41);
			fRec47[0] = ((fRec48[1] * fTemp42) + (fRec47[1] * fTemp43));
			fRec48[0] = ((fTemp29 + (fRec48[1] * fTemp43)) - (fTemp42 * fRec47[1]));
			int iTemp44 = ((fRec47[1] <= 0.0f) & (fRec47[0] > 0.0f));
			fRec46[0] = ((fRec46[1] * float((1 - iTemp44))) + (4.65661287e-10f * (fTemp31 * float(iTemp44))));
			int iTemp45 = (fRec46[0] > 0.99000001f);
			iVec6[0] = iTemp45;
			iRec45[0] = (((iRec45[1] + (iRec45[1] > 0)) * (iTemp45 <= iVec6[1])) + (iTemp45 > iVec6[1]));
			float fTemp46 = (float(iRec45[0]) / std::max<float>(1.0f, (fConst45 / fTemp33)));
			fRec44[0] = ((0.999000013f * fRec44[1]) + (0.00100000005f * std::max<float>(0.0f, std::min<float>(fTemp46, (2.0f - fTemp46)))));
			fRec49[0] = (fConst46 + (fRec49[1] - std::floor((fConst46 + fRec49[1]))));
			float fTemp47 = (fConst47 * fRec35[0]);
			float fTemp48 = std::sin(fTemp47);
			float fTemp49 = std::cos(fTemp47);
			fRec53[0] = ((fRec54[1] * fTemp48) + (fRec53[1] * fTemp49));
			fRec54[0] = ((fTemp29 + (fRec54[1] * fTemp49)) - (fTemp48 * fRec53[1]));
			int iTemp50 = ((fRec53[1] <= 0.0f) & (fRec53[0] > 0.0f));
			fRec52[0] = ((fRec52[1] * float((1 - iTemp50))) + (4.65661287e-10f * (fTemp31 * float(iTemp50))));
			int iTemp51 = (fRec52[0] > 0.99000001f);
			iVec7[0] = iTemp51;
			iRec51[0] = (((iRec51[1] + (iRec51[1] > 0)) * (iTemp51 <= iVec7[1])) + (iTemp51 > iVec7[1]));
			float fTemp52 = (float(iRec51[0]) / std::max<float>(1.0f, (fConst48 / fTemp33)));
			fRec50[0] = ((0.999000013f * fRec50[1]) + (0.00100000005f * std::max<float>(0.0f, std::min<float>(fTemp52, (2.0f - fTemp52)))));
			fRec55[0] = (fConst49 + (fRec55[1] - std::floor((fConst49 + fRec55[1]))));
			float fTemp53 = (fConst50 * fRec35[0]);
			float fTemp54 = std::sin(fTemp53);
			float fTemp55 = std::cos(fTemp53);
			fRec59[0] = ((fRec60[1] * fTemp54) + (fRec59[1] * fTemp55));
			fRec60[0] = ((fTemp29 + (fRec60[1] * fTemp55)) - (fTemp54 * fRec59[1]));
			int iTemp56 = ((fRec59[1] <= 0.0f) & (fRec59[0] > 0.0f));
			fRec58[0] = ((fRec58[1] * float((1 - iTemp56))) + (4.65661287e-10f * (fTemp31 * float(iTemp56))));
			int iTemp57 = (fRec58[0] > 0.99000001f);
			iVec8[0] = iTemp57;
			iRec57[0] = (((iRec57[1] + (iRec57[1] > 0)) * (iTemp57 <= iVec8[1])) + (iTemp57 > iVec8[1]));
			float fTemp58 = (float(iRec57[0]) / std::max<float>(1.0f, (fConst51 / fTemp33)));
			fRec56[0] = ((0.999000013f * fRec56[1]) + (0.00100000005f * std::max<float>(0.0f, std::min<float>(fTemp58, (2.0f - fTemp58)))));
			fRec61[0] = (fConst52 + (fRec61[1] - std::floor((fConst52 + fRec61[1]))));
			float fTemp59 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow17 * (((((fRec30[0] * ftbl0mydspSIG0[int((65536.0f * fRec37[0]))]) + (fRec38[0] * ftbl0mydspSIG0[int((65536.0f * fRec43[0]))])) + (fRec44[0] * ftbl0mydspSIG0[int((65536.0f * fRec49[0]))])) + (fRec50[0] * ftbl0mydspSIG0[int((65536.0f * fRec55[0]))])) + (fRec56[0] * ftbl0mydspSIG0[int((65536.0f * fRec61[0]))])))));
			fRec29[0] = ((fTemp59 * (1.0f - (0.333333343f * mydsp_faustpower2_f(fTemp59)))) - (fSlow13 * ((fSlow19 * fRec29[2]) + (fSlow20 * fRec29[1]))));
			float fTemp60 = (fSlow13 * (((fSlow16 * fRec29[0]) + (fSlow21 * fRec29[1])) + (fSlow16 * fRec29[2])));
			fVec9[0] = fTemp60;
			fRec28[0] = (0.0f - (fSlow11 * ((fSlow12 * fRec28[1]) - (fTemp60 + fVec9[1]))));
			fRec62[0] = (fSlow22 + (0.999000013f * fRec62[1]));
			float fTemp61 = std::fabs(fRec28[0]);
			float fTemp62 = ((fRec64[1] > fTemp61) ? fConst19 : fConst18);
			fRec65[0] = ((fRec65[1] * fTemp62) + (fTemp61 * (1.0f - fTemp62)));
			fRec64[0] = fRec65[0];
			fRec63[0] = ((fConst16 * fRec63[1]) + (fConst17 * (0.0f - (0.99000001f * std::max<float>(((20.0f * std::log10(fRec64[0])) + 5.0f), 0.0f)))));
			float fTemp63 = ((fRec28[0] * fRec62[0]) * std::pow(10.0f, (0.0500000007f * fRec63[0])));
			float fTemp64 = (fTemp7 + (fRec13[0] + fTemp63));
			float fTemp65 = std::fabs(fTemp64);
			float fTemp66 = ((fRec67[1] > fTemp65) ? fConst28 : fConst18);
			fRec68[0] = ((fRec68[1] * fTemp66) + (fTemp65 * (1.0f - fTemp66)));
			fRec67[0] = fRec68[0];
			fRec66[0] = ((fConst16 * fRec66[1]) + (fSlow23 * std::max<float>(((20.0f * std::log10(fRec67[0])) - fSlow24), 0.0f)));
			output0[i] = FAUSTFLOAT((fSlow0 * (fTemp64 * std::pow(10.0f, (0.0500000007f * fRec66[0])))));
			float fTemp67 = (fRec73[1] + (fConst54 * fTemp8));
			fRec73[0] = (fTemp67 - std::floor(fTemp67));
			int iTemp68 = ((fRec73[0] - fRec73[1]) < 0.0f);
			fRec72[0] = (iTemp68 ? fSlow37 : fRec72[1]);
			float fTemp69 = (fRec71[1] + (fConst53 * std::pow(2.0f, (0.0833333358f * (fRec72[0] + -69.0f)))));
			fRec71[0] = (fTemp69 - std::floor(fTemp69));
			fRec75[0] = (iTemp68 ? (((4.65661287e-10f * fTemp31) + 1.0f) * float(iTemp68)) : fRec75[1]);
			int iTemp70 = (fRec75[0] > 0.800000012f);
			iVec10[0] = iTemp70;
			iRec74[0] = (iTemp70 + (iRec74[1] * (iVec10[1] >= iTemp70)));
			iRec76[0] = ((iTemp70 == 0) * (iRec76[1] + 1));
			float fTemp71 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow36 * (ftbl0mydspSIG0[int((65536.0f * fRec71[0]))] * std::max<float>(0.0f, (std::min<float>((float(iRec74[0]) / std::max<float>(1.0f, (fConst55 / fTemp8))), 1.0f) - (float(iRec76[0]) / std::max<float>(1.0f, (fConst56 / fTemp8)))))))));
			fRec70[0] = ((fTemp71 * (1.0f - (0.333333343f * mydsp_faustpower2_f(fTemp71)))) - (fSlow32 * ((fSlow38 * fRec70[2]) + (fSlow39 * fRec70[1]))));
			float fTemp72 = (fSlow32 * (((fSlow35 * fRec70[0]) + (fSlow40 * fRec70[1])) + (fSlow35 * fRec70[2])));
			fVec11[0] = fTemp72;
			fRec69[0] = (0.0f - (fSlow30 * ((fSlow31 * fRec69[1]) - (fTemp72 + fVec11[1]))));
			float fTemp73 = (fRec13[0] + (fSlow27 * fRec69[0]));
			float fTemp74 = std::fabs(fTemp73);
			float fTemp75 = ((fRec78[1] > fTemp74) ? fConst18 : fConst16);
			fRec79[0] = ((fRec79[1] * fTemp75) + (fTemp74 * (1.0f - fTemp75)));
			fRec78[0] = fRec79[0];
			fRec77[0] = ((fConst32 * fRec77[1]) + (fConst33 * (0.0f - (0.99000001f * std::max<float>(((20.0f * std::log10(fRec78[0])) + 5.0f), 0.0f)))));
			float fTemp76 = (((fRec15[0] * fTemp73) * std::pow(10.0f, (0.0500000007f * fRec77[0]))) + (fTemp7 + (0.5f * fTemp63)));
			float fTemp77 = std::fabs((fSlow25 * fTemp76));
			float fTemp78 = ((fRec81[1] > fTemp77) ? fConst28 : fConst18);
			fRec82[0] = ((fRec82[1] * fTemp78) + (fTemp77 * (1.0f - fTemp78)));
			fRec81[0] = fRec82[0];
			fRec80[0] = ((fConst16 * fRec80[1]) + (fSlow23 * std::max<float>(((20.0f * std::log10(fRec81[0])) - fSlow24), 0.0f)));
			output1[i] = FAUSTFLOAT((fSlow26 * (fTemp76 * std::pow(10.0f, (0.0500000007f * fRec80[0])))));
			iVec0[1] = iVec0[0];
			fRec2[1] = fRec2[0];
			fRec5[1] = fRec5[0];
			fRec4[1] = fRec4[0];
	...
	FAUST_ADDHORIZONTALSLIDER("kickVol", fHslider3, 1.2f, 0.0f, 10.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("kikSpd", fHslider5, 0.10000000000000001f, 0.10000000000000001f, 2.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("mcomp", fHslider11, -10.0f, -50.0f, 0.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("mcompra", fHslider10, 100.0f, 1.0f, 100.0f, 0.01f);
	...
	FAUST_ADDHORIZONTALSLIDER("techno", fHslider4, 0.0f, 0.0f, 1.0f, 0.01f);
	...
	#define FAUST_LIST_ACTIVES(p) \
		...
		p(HORIZONTALSLIDER, kickVol, "kickVol", fHslider3, 1.2f, 0.0f, 10.0f, 0.01f) \
		p(HORIZONTALSLIDER, kikSpd, "kikSpd", fHslider5, 0.10000000000000001f, 0.10000000000000001f, 2.0f, 0.01f) \
		p(HORIZONTALSLIDER, mcomp, "mcomp", fHslider11, -10.0f, -50.0f, 0.0f, 0.01f) \
		p(HORIZONTALSLIDER, mcompra, "mcompra", fHslider10, 100.0f, 1.0f, 100.0f, 0.01f) \
		...
		p(HORIZONTALSLIDER, techno, "techno", fHslider4, 0.0f, 0.0f, 1.0f, 0.01f) \
