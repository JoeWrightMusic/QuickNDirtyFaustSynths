...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "firewater.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst4 = (1.0f / (fConst3 + 0.822445929f));
		fConst5 = (0.822445929f - fConst3);
		fConst6 = (1.0f / (((fConst3 + 0.802636743f) / fConst2) + 1.4122709f));
		fConst7 = mydsp_faustpower2_f(fConst2);
		fConst8 = (0.0198091455f / fConst7);
		fConst9 = (fConst8 + 1.16151643f);
		fConst10 = std::max<float>(1.0f, (0.0149999997f * fConst0));
		fConst11 = (1.0f / fConst10);
		fConst12 = (6.28318548f / fConst0);
		fConst13 = (1.0f / std::max<float>(1.0f, fConst0));
		fConst14 = std::exp((0.0f - (20.0f / fConst0)));
		fConst15 = (1.0f - fConst14);
		fConst16 = (125.663704f / fConst0);
		fConst17 = std::sin(fConst16);
		fConst18 = std::cos(fConst16);
		fConst19 = (((fConst3 + -0.802636743f) / fConst2) + 1.4122709f);
		fConst20 = (2.0f * (1.4122709f - (1.0f / fConst7)));
		fConst21 = (2.0f * (1.16151643f - fConst8));
		fConst22 = std::tan((6283.18555f / fConst0));
		fConst23 = (1.0f / fConst22);
		fConst24 = (1.0f / (((fConst23 + 1.0f) / fConst22) + 1.0f));
		fConst25 = std::exp((0.0f - fConst1));
		fConst26 = (1.0f - fConst25);
		fConst27 = std::sin(fConst12);
		fConst28 = std::cos(fConst12);
		fConst29 = (3.14159274f / fConst0);
		fConst30 = std::exp((0.0f - (0.400000006f / fConst0)));
		fConst31 = (1.0f - fConst30);
		fConst32 = (2.51327419f / fConst0);
		fConst33 = std::sin(fConst32);
		fConst34 = std::cos(fConst32);
		fConst35 = (1.0f - ((1.0f - fConst23) / fConst22));
		fConst36 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fConst22))));
		fConst37 = std::max<float>(1.0f, (9.99999975e-06f * fConst0));
		fConst38 = (1.0f / fConst37);
		fConst39 = std::exp((0.0f - (5.0f / fConst0)));
		fConst40 = (1.0f - fConst39);
		fConst41 = (31.415926f / fConst0);
		fConst42 = std::sin(fConst41);
		fConst43 = std::cos(fConst41);
		fConst44 = (1.2566371f / fConst0);
		fConst45 = std::max<float>(1.0f, (9.99999997e-07f * fConst0));
		fConst46 = (1.0f / fConst45);
		fConst47 = (62.831852f / fConst0);
		fConst48 = std::exp((0.0f - (2500.0f / fConst0)));
		fConst49 = (1.0f - fConst48);
		fConst50 = std::exp((0.0f - (1250.0f / fConst0)));
		fConst51 = std::exp((0.0f - (2.0f / fConst0)));
	}
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider6 = FAUSTFLOAT(0.050000000000000003f);
		fHslider7 = FAUSTFLOAT(0.40000000000000002f);
		fHslider8 = FAUSTFLOAT(30.0f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("firewater");
		ui_interface->addHorizontalSlider("fireWater", &fHslider3, 0.0f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("hiss", &fHslider6, 0.0500000007f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("maxPop", &fHslider8, 30.0f, 20.0f, 200.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("maxWater", &fHslider4, 300.0f, 0.0f, 900.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("phut", &fHslider7, 0.400000006f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("pop", &fHslider9, 0.400000006f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("vol", &fHslider1, 0.0f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("volSmth", &fHslider0, 0.200000003f, 0.0f, 2.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("waterSmth", &fHslider2, 0.200000003f, 0.0f, 4.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("woof", &fHslider5, 0.100000001f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow2 = (iSlow1 ? 0.0f : std::exp((0.0f - (fConst1 / (iSlow1 ? 1.0f : fSlow0)))));
		float fSlow3 = (float(fHslider1) * (1.0f - fSlow2));
		float fSlow4 = float(fHslider2);
		int iSlow5 = (std::fabs(fSlow4) < 1.1920929e-07f);
		float fSlow6 = (iSlow5 ? 0.0f : std::exp((0.0f - (fConst1 / (iSlow5 ? 1.0f : fSlow4)))));
		float fSlow7 = float(fHslider3);
		float fSlow8 = ((3.0f * std::max<float>(0.0f, (0.330000013f - fSlow7))) * (1.0f - fSlow6));
		float fSlow9 = float(fHslider4);
		float fSlow10 = (fConst24 * float(fHslider5));
		float fSlow11 = std::max<float>(0.100000001f, (fSlow7 + -0.300000012f));
		float fSlow12 = ((20.0f * fSlow11) + 1.0f);
		float fSlow13 = (1.0f / fSlow12);
		int iSlow14 = (std::fabs(fSlow13) < 1.1920929e-07f);
		float fSlow15 = (iSlow14 ? 0.0f : std::exp((0.0f - (fConst1 / (iSlow14 ? 1.0f : fSlow13)))));
		float fSlow16 = (fConst12 * fSlow12);
		float fSlow17 = std::sin(fSlow16);
		float fSlow18 = std::cos(fSlow16);
		float fSlow19 = (1.0f - fSlow15);
		float fSlow20 = (2.5f / fSlow12);
		int iSlow21 = (std::fabs(fSlow20) < 1.1920929e-07f);
		float fSlow22 = (iSlow21 ? 0.0f : std::exp((0.0f - (fConst1 / (iSlow21 ? 1.0f : fSlow20)))));
		float fSlow23 = (fConst32 * fSlow12);
		float fSlow24 = std::sin(fSlow23);
		float fSlow25 = std::cos(fSlow23);
		float fSlow26 = (1.0f - fSlow22);
		float fSlow27 = float(fHslider6);
		float fSlow28 = (1.0f / fSlow11);
		int iSlow29 = (std::fabs(fSlow28) < 1.1920929e-07f);
		float fSlow30 = (iSlow29 ? 0.0f : std::exp((0.0f - (fConst1 / (iSlow29 ? 1.0f : fSlow28)))));
		float fSlow31 = (fConst12 * fSlow11);
		float fSlow32 = std::sin(fSlow31);
		float fSlow33 = std::cos(fSlow31);
		float fSlow34 = (1.0f - fSlow30);
		float fSlow35 = (2.5f / fSlow11);
		int iSlow36 = (std::fabs(fSlow35) < 1.1920929e-07f);
		float fSlow37 = (iSlow36 ? 0.0f : std::exp((0.0f - (fConst1 / (iSlow36 ? 1.0f : fSlow35)))));
		float fSlow38 = (fConst32 * fSlow11);
		float fSlow39 = std::sin(fSlow38);
		float fSlow40 = std::cos(fSlow38);
		float fSlow41 = (1.0f - fSlow37);
		float fSlow42 = float(fHslider7);
		float fSlow43 = (float(fHslider8) * fSlow11);
		float fSlow44 = ((0.100000001f * fSlow43) + 1.0f);
		float fSlow45 = (1.0f / fSlow44);
		int iSlow46 = (std::fabs(fSlow45) < 1.1920929e-07f);
		float fSlow47 = (iSlow46 ? 0.0f : std::exp((0.0f - (fConst1 / (iSlow46 ? 1.0f : fSlow45)))));
		float fSlow48 = (fConst12 * fSlow44);
		float fSlow49 = std::sin(fSlow48);
		float fSlow50 = std::cos(fSlow48);
		float fSlow51 = (1.0f - fSlow47);
		float fSlow52 = float(fHslider9);
		float fSlow53 = (5.0f / fSlow43);
		int iSlow54 = (std::fabs(fSlow53) < 1.1920929e-07f);
		float fSlow55 = (iSlow54 ? 0.0f : std::exp((0.0f - (fConst1 / (iSlow54 ? 1.0f : fSlow53)))));
		float fSlow56 = (fConst44 * fSlow43);
		float fSlow57 = std::sin(fSlow56);
		float fSlow58 = std::cos(fSlow56);
		float fSlow59 = (1.0f - fSlow55);
		float fSlow60 = (2.0f / fSlow43);
		int iSlow61 = (std::fabs(fSlow60) < 1.1920929e-07f);
		float fSlow62 = (iSlow61 ? 0.0f : std::exp((0.0f - (fConst1 / (iSlow61 ? 1.0f : fSlow60)))));
		float fSlow63 = (fConst29 * fSlow43);
		float fSlow64 = std::sin(fSlow63);
		float fSlow65 = std::cos(fSlow63);
		float fSlow66 = (1.0f - fSlow62);
		float fSlow67 = (fConst12 * fSlow43);
		float fSlow68 = std::sin(fSlow67);
		float fSlow69 = std::cos(fSlow67);
		float fSlow70 = (0.100000001f / fSlow43);
		int iSlow71 = (std::fabs(fSlow70) < 1.1920929e-07f);
		float fSlow72 = (iSlow71 ? 0.0f : std::exp((0.0f - (fConst1 / (iSlow71 ? 1.0f : fSlow70)))));
		float fSlow73 = (fConst47 * fSlow43);
		float fSlow74 = std::sin(fSlow73);
		float fSlow75 = std::cos(fSlow73);
		float fSlow76 = (1.0f - fSlow72);
		for (int i = 0; (i < count); i = (i + 1)) {
			iVec0[0] = 1;
			fRec0[0] = ((fRec0[1] * fSlow2) + fSlow3);
			fRec1[0] = ((fRec1[1] * fSlow6) + fSlow8);
			float fTemp0 = (fConst12 * ((fSlow9 * mydsp_faustpower2_f(fRec1[0])) + 50.0f));
			float fTemp1 = std::sin(fTemp0);
			float fTemp2 = std::cos(fTemp0);
			fRec6[0] = ((fRec7[1] * fTemp1) + (fRec6[1] * fTemp2));
			float fTemp3 = float((1 - iVec0[1]));
			fRec7[0] = ((fTemp3 + (fRec7[1] * fTemp2)) - (fTemp1 * fRec6[1]));
			int iTemp4 = ((fRec6[1] <= 0.0f) & (fRec6[0] > 0.0f));
			iRec8[0] = ((1103515245 * iRec8[1]) + 12345);
			float fTemp5 = float(iRec8[0]);
			fRec5[0] = ((fRec5[1] * float((1 - iTemp4))) + (4.65661287e-10f * (fTemp5 * float(iTemp4))));
			int iTemp6 = (fRec5[0] > 0.699999988f);
			iVec1[0] = iTemp6;
			iRec4[0] = (((iRec4[1] + (iRec4[1] > 0)) * (iTemp6 <= iVec1[1])) + (iTemp6 > iVec1[1]));
			float fTemp7 = float(iRec4[0]);
			float fTemp8 = std::max<float>(0.0f, std::min<float>((fConst11 * fTemp7), (1.0f - (fConst13 * (fTemp7 - fConst10)))));
			fRec13[0] = ((fConst17 * fRec14[1]) + (fConst18 * fRec13[1]));
			fRec14[0] = ((fTemp3 + (fConst18 * fRec14[1])) - (fConst17 * fRec13[1]));
			int iTemp9 = ((fRec13[1] <= 0.0f) & (fRec13[0] > 0.0f));
			fRec12[0] = ((fRec12[1] * float((1 - iTemp9))) + (4.65661287e-10f * (fTemp5 * float(iTemp9))));
			fRec11[0] = ((fConst14 * fRec11[1]) + (fConst15 * fRec12[0]));
			float fTemp10 = (fRec10[1] + (fConst1 * (((440.0f * std::pow(2.0f, (0.0833333358f * ((14.0f * fRec5[0]) + 25.0f)))) + (300.0f * fRec11[0])) + (17.0f * fTemp8))));
			fRec10[0] = (fTemp10 - std::floor(fTemp10));
			fRec3[0] = ((0.300000012f * (fTemp8 * ftbl0mydspSIG0[int((65536.0f * fRec10[0]))])) - (fConst6 * ((fConst19 * fRec3[2]) + (fConst20 * fRec3[1]))));
			float fTemp11 = (((fConst9 * fRec3[0]) + (fConst21 * fRec3[1])) + (fConst9 * fRec3[2]));
			fVec2[0] = fTemp11;
			fRec2[0] = (0.0f - (fConst4 * ((fConst5 * fRec2[1]) - (fConst6 * (fTemp11 + fVec2[1])))));
			fRec19[0] = ((fConst27 * fRec20[1]) + (fConst28 * fRec19[1]));
			fRec20[0] = ((fTemp3 + (fConst28 * fRec20[1])) - (fConst27 * fRec19[1]));
			int iTemp12 = ((fRec19[1] <= 0.0f) & (fRec19[0] > 0.0f));
			fRec18[0] = ((fRec18[1] * float((1 - iTemp12))) + (4.65661287e-10f * (fTemp5 * float(iTemp12))));
			fRec17[0] = ((fConst25 * fRec17[1]) + (fConst26 * fRec18[0]));
			fRec21[0] = (((0.522189379f * fRec21[3]) + ((4.65661287e-10f * fTemp5) + (2.49495602f * fRec21[1]))) - (2.0172658f * fRec21[2]));
			float fTemp13 = (((0.0499220341f * fRec21[0]) + (0.0506126992f * fRec21[2])) - ((0.0959935337f * fRec21[1]) + (0.00440878607f * fRec21[3])));
			fRec24[0] = ((fConst33 * fRec25[1]) + (fConst34 * fRec24[1]));
			fRec25[0] = ((fTemp3 + (fConst34 * fRec25[1])) - (fConst33 * fRec24[1]));
			int iTemp14 = ((fRec24[1] <= 0.0f) & (fRec24[0] > 0.0f));
			fRec23[0] = ((fRec23[1] * float((1 - iTemp14))) + (4.65661287e-10f * (fTemp5 * float(iTemp14))));
			fRec22[0] = ((fConst30 * fRec22[1]) + (fConst31 * fRec23[0]));
			float fTemp15 = std::tan((fConst29 * ((35.0f * fRec22[0]) + 70.0f)));
			float fTemp16 = (1.0f / fTemp15);
			float fTemp17 = (((fTemp16 + 0.333333343f) / fTemp15) + 1.0f);
			fRec16[0] = ((100.0f * (mydsp_faustpower2_f(fRec17[0]) * fTemp13)) - (((fRec16[2] * (((fTemp16 + -0.333333343f) / fTemp15) + 1.0f)) + (2.0f * (fRec16[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp15)))))) / fTemp17));
			fRec15[0] = (std::max<float>(-1.0f, std::min<float>(1.0f, (((fRec16[1] + (0.5f * fRec16[0])) + (0.5f * fRec16[2])) / fTemp17))) - (fConst24 * ((fConst35 * fRec15[2]) + (fConst36 * fRec15[1]))));
			fRec30[0] = ((fSlow17 * fRec31[1]) + (fSlow18 * fRec30[1]));
			fRec31[0] = ((fTemp3 + (fSlow18 * fRec31[1])) - (fSlow17 * fRec30[1]));
			int iTemp18 = ((fRec30[1] <= 0.0f) & (fRec30[0] > 0.0f));
			fRec29[0] = ((fRec29[1] * float((1 - iTemp18))) + (4.65661287e-10f * (fTemp5 * float(iTemp18))));
			fRec28[0] = ((fRec28[1] * fSlow15) + (fRec29[0] * fSlow19));
			fRec34[0] = ((fSlow24 * fRec35[1]) + (fSlow25 * fRec34[1]));
			fRec35[0] = ((fTemp3 + (fSlow25 * fRec35[1])) - (fSlow24 * fRec34[1]));
			int iTemp19 = ((fRec34[1] <= 0.0f) & (fRec34[0] > 0.0f));
			fRec33[0] = ((fRec33[1] * float((1 - iTemp19))) + (4.65661287e-10f * (fTemp5 * float(iTemp19))));
			fRec32[0] = ((fRec32[1] * fSlow22) + (fRec33[0] * fSlow26));
			float fTemp20 = std::tan((fConst29 * ((35.0f * fRec32[0]) + 70.0f)));
			float fTemp21 = (1.0f / fTemp20);
			float fTemp22 = (((fTemp21 + 0.333333343f) / fTemp20) + 1.0f);
			fRec27[0] = ((100.0f * (mydsp_faustpower2_f(fRec28[0]) * fTemp13)) - (((fRec27[2] * (((fTemp21 + -0.333333343f) / fTemp20) + 1.0f)) + (2.0f * (fRec27[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp20)))))) / fTemp22));
			fRec26[0] = (std::max<float>(-1.0f, std::min<float>(1.0f, (((fRec27[1] + (0.5f * fRec27[0])) + (0.5f * fRec27[2])) / fTemp22))) - (fConst24 * ((fConst35 * fRec26[2]) + (fConst36 * fRec26[1]))));
			fRec38[0] = ((fSlow32 * fRec39[1]) + (fSlow33 * fRec38[1]));
			fRec39[0] = ((fTemp3 + (fSlow33 * fRec39[1])) - (fSlow32 * fRec38[1]));
			int iTemp23 = ((fRec38[1] <= 0.0f) & (fRec38[0] > 0.0f));
			fRec37[0] = ((fRec37[1] * float((1 - iTemp23))) + (4.65661287e-10f * (fTemp5 * float(iTemp23))));
			fRec36[0] = ((fRec36[1] * fSlow30) + (fRec37[0] * fSlow34));
			float fTemp24 = (mydsp_faustpower2_f(fRec36[0]) * fTemp5);
			fRec43[0] = ((fSlow39 * fRec44[1]) + (fSlow40 * fRec43[1]));
			fRec44[0] = ((fTemp3 + (fSlow40 * fRec44[1])) - (fSlow39 * fRec43[1]));
			int iTemp25 = ((fRec43[1] <= 0.0f) & (fRec43[0] > 0.0f));
			fRec42[0] = ((fRec42[1] * float((1 - iTemp25))) + (4.65661287e-10f * (fTemp5 * float(iTemp25))));
			fRec41[0] = ((fRec41[1] * fSlow37) + (fRec42[0] * fSlow41));
			float fTemp26 = std::tan((fConst29 * ((3750.0f * fRec41[0]) + 7500.0f)));
			float fTemp27 = (1.0f / fTemp26);
			float fTemp28 = (((fTemp27 + 0.333333343f) / fTemp26) + 1.0f);
			fRec40[0] = ((4.65661287e-10f * fTemp24) - (((fRec40[2] * (((fTemp27 + -0.333333343f) / fTemp26) + 1.0f)) + (2.0f * (fRec40[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp26)))))) / fTemp28));
			fRec47[0] = ((fSlow49 * fRec48[1]) + (fSlow50 * fRec47[1]));
			fRec48[0] = ((fTemp3 + (fSlow50 * fRec48[1])) - (fSlow49 * fRec47[1]));
			int iTemp29 = ((fRec47[1] <= 0.0f) & (fRec47[0] > 0.0f));
			fRec46[0] = ((fRec46[1] * float((1 - iTemp29))) + (4.65661287e-10f * (fTemp5 * float(iTemp29))));
			fRec45[0] = ((fRec45[1] * fSlow47) + (fRec46[0] * fSlow51));
			int iTemp30 = (fRec46[0] > 0.699999988f);
			iVec3[0] = iTemp30;
			iRec50[0] = (((iRec50[1] + (iRec50[1] > 0)) * (iTemp30 <= iVec3[1])) + (iTemp30 > iVec3[1]));
			float fTemp31 = float(iRec50[0]);
			fRec53[0] = ((fConst42 * fRec54[1]) + (fConst43 * fRec53[1]));
			fRec54[0] = ((fTemp3 + (fConst43 * fRec54[1])) - (fConst42 * fRec53[1]));
			int iTemp32 = ((fRec53[1] <= 0.0f) & (fRec53[0] > 0.0f));
			fRec52[0] = ((fRec52[1] * float((1 - iTemp32))) + (4.65661287e-10f * (fTemp5 * float(iTemp32))));
			fRec51[0] = ((fConst39 * fRec51[1]) + (fConst40 * fRec52[0]));
			float fTemp33 = std::tan((fConst29 * ((1050.0f * fRec45[0]) + 2100.0f)));
			float fTemp34 = (1.0f / fTemp33);
			float fTemp35 = (((fTemp34 + 0.25f) / fTemp33) + 1.0f);
			fRec49[0] = ((4.65661287e-10f * (fTemp5 * std::max<float>(0.0f, std::min<float>((fConst38 * fTemp31), (((fConst37 - fTemp31) / std::max<float>(1.0f, (fConst0 * ((0.00994999986f * fRec51[0]) + 0.0198999997f)))) + 1.0f))))) - (((fRec49[2] * (((fTemp34 + -0.25f) / fTemp33) + 1.0f)) + (2.0f * (fRec49[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp33)))))) / fTemp35));
			fRec57[0] = ((fSlow57 * fRec58[1]) + (fSlow58 * fRec57[1]));
			fRec58[0] = ((fTemp3 + (fSlow58 * fRec58[1])) - (fSlow57 * fRec57[1]));
			int iTemp36 = ((fRec57[1] <= 0.0f) & (fRec57[0] > 0.0f));
			fRec56[0] = ((fRec56[1] * float((1 - iTemp36))) + (4.65661287e-10f * (fTemp5 * float(iTemp36))));
			fRec55[0] = ((fRec55[1] * fSlow55) + (fRec56[0] * fSlow59));
			fRec61[0] = ((fSlow64 * fRec62[1]) + (fSlow65 * fRec61[1]));
			fRec62[0] = ((fTemp3 + (fSlow65 * fRec62[1])) - (fSlow64 * fRec61[1]));
			int iTemp37 = ((fRec61[1] <= 0.0f) & (fRec61[0] > 0.0f));
			fRec60[0] = ((fRec60[1] * float((1 - iTemp37))) + (4.65661287e-10f * (fTemp5 * float(iTemp37))));
			fRec59[0] = ((fRec59[1] * fSlow62) + (fRec60[0] * fSlow66));
			fRec66[0] = ((fSlow68 * fRec67[1]) + (fSlow69 * fRec66[1]));
			fRec67[0] = ((fTemp3 + (fSlow69 * fRec67[1])) - (fSlow68 * fRec66[1]));
			int iTemp38 = ((fRec66[1] <= 0.0f) & (fRec66[0] > 0.0f));
			fRec65[0] = ((fRec65[1] * float((1 - iTemp38))) + (4.65661287e-10f * (fTemp5 * float(iTemp38))));
			int iTemp39 = (fRec65[0] > 0.699999988f);
			iVec4[0] = iTemp39;
			iRec64[0] = (((iRec64[1] + (iRec64[1] > 0)) * (iTemp39 <= iVec4[1])) + (iTemp39 > iVec4[1]));
			float fTemp40 = float(iRec64[0]);
			fRec70[0] = ((fSlow74 * fRec71[1]) + (fSlow75 * fRec70[1]));
			fRec71[0] = ((fTemp3 + (fSlow75 * fRec71[1])) - (fSlow74 * fRec70[1]));
			int iTemp41 = ((fRec70[1] <= 0.0f) & (fRec70[0] > 0.0f));
			fRec69[0] = ((fRec69[1] * float((1 - iTemp41))) + (4.65661287e-10f * (fTemp5 * float(iTemp41))));
			fRec68[0] = ((fRec68[1] * fSlow72) + (fRec69[0] * fSlow76));
			float fTemp42 = std::tan((fConst29 * ((7200.0f * fRec68[0]) + 14400.0f)));
			float fTemp43 = (1.0f / fTemp42);
			float fTemp44 = (((fTemp43 + 1.0f) / fTemp42) + 1.0f);
			fRec63[0] = (std::max<float>(0.0f, std::min<float>((fConst46 * fTemp40), ((fConst38 * (fConst45 - fTemp40)) + 1.0f))) - (((fRec63[2] * (1.0f - ((1.0f - fTemp43) / fTemp42))) + (2.0f * (fRec63[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp42)))))) / fTemp44));
			float fTemp45 = std::max<float>(-1.0f, std::min<float>(1.0f, ((((fSlow10 * ((fRec15[2] + (fRec15[0] + (2.0f * fRec15[1]))) + (fRec26[2] + (fRec26[0] + (2.0f * fRec26[1]))))) + (fSlow27 * ((2.32830644e-10f * fTemp24) - (((fRec40[1] + (0.5f * fRec40[0])) + (0.5f * fRec40[2])) / fTemp28)))) + (fSlow42 * ((fRec45[0] * ((fRec49[1] + (0.5f * fRec49[0])) + (0.5f * fRec49[2]))) / fTemp35))) + (fSlow52 * (((fRec55[0] * fRec59[0]) * (fRec63[2] + (fRec63[0] + (2.0f * fRec63[1])))) / fTemp44)))));
			float fTemp46 = std::fabs(fTemp45);
			float fTemp47 = ((fRec73[1] > fTemp46) ? fConst51 : fConst50);
			fRec74[0] = ((fRec74[1] * fTemp47) + (fTemp46 * (1.0f - fTemp47)));
			fRec73[0] = fRec74[0];
			fRec72[0] = ((fConst48 * fRec72[1]) + (fConst49 * (0.0f - (0.75f * std::max<float>(((20.0f * std::log10(fRec73[0])) + 6.0f), 0.0f)))));
			output0[i] = FAUSTFLOAT((fRec0[0] * ((0.800000012f * (fRec1[0] * fRec2[0])) + (fSlow7 * (fTemp45 * std::pow(10.0f, (0.0500000007f * fRec72[0])))))));
			iVec0[1] = iVec0[0];
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec6[1] = fRec6[0];
	...
	#define FAUST_FILE_NAME "firewater.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("fireWater", fHslider3, 0.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("hiss", fHslider6, 0.050000000000000003f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("maxPop", fHslider8, 30.0f, 20.0f, 200.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("maxWater", fHslider4, 300.0f, 0.0f, 900.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("phut", fHslider7, 0.40000000000000002f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("pop", fHslider9, 0.40000000000000002f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("vol", fHslider1, 0.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("volSmth", fHslider0, 0.20000000000000001f, 0.0f, 2.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("waterSmth", fHslider2, 0.20000000000000001f, 0.0f, 4.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("woof", fHslider5, 0.10000000000000001f, 0.0f, 1.0f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, fireWater, "fireWater", fHslider3, 0.0f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, hiss, "hiss", fHslider6, 0.050000000000000003f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, maxPop, "maxPop", fHslider8, 30.0f, 20.0f, 200.0f, 0.01f) \
		p(HORIZONTALSLIDER, maxWater, "maxWater", fHslider4, 300.0f, 0.0f, 900.0f, 0.01f) \
		p(HORIZONTALSLIDER, phut, "phut", fHslider7, 0.40000000000000002f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, pop, "pop", fHslider9, 0.40000000000000002f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, vol, "vol", fHslider1, 0.0f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, volSmth, "volSmth", fHslider0, 0.20000000000000001f, 0.0f, 2.0f, 0.01f) \
		p(HORIZONTALSLIDER, waterSmth, "waterSmth", fHslider2, 0.20000000000000001f, 0.0f, 4.0f, 0.01f) \
		p(HORIZONTALSLIDER, woof, "woof", fHslider5, 0.10000000000000001f, 0.0f, 1.0f, 0.01f) \
...
firewater::firewater() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void firewater::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void firewater::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float firewater::getParamValue(const std::string& path)
{
